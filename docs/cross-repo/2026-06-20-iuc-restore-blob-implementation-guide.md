...
2026-06-20.
**Server design / rationale:** `docs/superpowers/specs/2026-06-20-iuc-restore-blob-design.md` *(agora-server repo)*
**Feature design (SDK side):** `docs/superpowers/specs/2026-06-18-iuc-history-restore-design.md` *(this repo)*
**Answers the request:** `docs/cross-repo/2026-06-20-iuc-restore-blob-server-request.md` *(this repo)*
...
- [ ] Type-only re-export `UploadRestoreBlobBody`, `RestoreBlobModel`, `UploadRestoreBlobResponse` from
      `@agora-server/contract` (added in the minor bump 0.9.x → 0.10.0) into `core/src/contract/`.
